...
def bake_whiteemission_texture(
...
# 指定オブジェクトの放射(Emmission)情報のみをベイクする
def bake_emission(arg_object:bpy.types.Object,
  ...
  arg_onesample:bool=False, arg_GPUuse:bool=False):
    ...
    bpy.ops.object.bake(type='EMIT', margin=arg_bakemargin)
